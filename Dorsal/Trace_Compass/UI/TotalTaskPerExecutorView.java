 ...
 *
 */
public class TotalTaskPerExecutorView extends TmfChartView {
    /** The view's ID */
    public static final String ID = "org.eclipse.tracecompass.incubator.spark_test1.ui.totalTasks"; //$NON-NLS-1$


    /**
     * Default constructor
     */
    public TotalTaskPerExecutorView() {
        super("Total Tasks Per Executor"); //$NON-NLS-1$
    }
    ...
    protected TmfXYChartViewer createChartViewer(@Nullable Composite parent) {
        TmfXYChartSettings settings = new TmfXYChartSettings("Tasks Per Executor", //$NON-NLS-1$
                "TIME", "Number of total tasks", 1); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private static String getDataProviderID() {
        return TaskXYDataProviderFactory.ID + ":2";
    }
